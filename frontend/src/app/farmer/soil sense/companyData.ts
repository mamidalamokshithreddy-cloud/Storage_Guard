...
// Helper function to create default additional fields
const createDefaultFields = () => ({
  specializations: ['General Soil Testing', 'Nutrient Analysis'],
  successRate: 95,
  ...
  insurance: true,
  warranty: '3 months service guarantee',
  additionalServices: ['Report Analysis', 'Recommendations']
});

// Satellite Analysis Companies
const satelliteCompanies: Company[] = [
  ...
  },
  {
    ...
    location: {
      address: 'Industrial Estate, Kazipet',
      district: 'Warangal',
      distance: '4.1 km'
    },
    pricing: {
  ...
  specializations: ['AI Satellite Analysis', 'Temporal Analysis', 'Yield Prediction'],
  successRate: 97,
...
const fieldTestingCompanies: Company[] = [
  ...
  specializations: ['Field Soil Testing', 'On-site Analysis'],
  successRate: 93,
  ...
  specializations: ['Government Field Testing', 'Subsidized Programs'],
  successRate: 92,
  ...
  paymentMethods: ['Government Portal', 'DBT', 'Cash'],
  insurance: true,
  warranty: 'Government backed service',
  additionalServices: ['Farmer Training', 'Health Cards']
  },
  {
    id: 'field-003',
  ...
  specializations: ['Certified Field Testing', 'Micronutrient Analysis'],
  successRate: 95,
  ...
  insurance: true,
  warranty: '6 months service guarantee',
  additionalServices: ['Seasonal Recommendations']
  }
];
...
const droneLabCompanies: Company[] = [
  ...
  turnaroundTime: '3-5 days',
  specializations: ['Aerial Sampling', 'Imaging Analysis'],
  successRate: 94,
  completedProjects: 700,
  workingHours: '7:00 AM - 7:00 PM',
  languages: ['Telugu', 'Hindi', 'English'],
  paymentMethods: ['UPI', 'Bank Transfer', 'Cash'],
  insurance: true,
  warranty: '3 months accuracy guarantee',
  additionalServices: ['Report Explanation', 'Crop Recommendation']
  },
  {
    id: 'drone-002',
  ...
  specializations: ['Government Drone Lab', 'Research Analysis'],
  successRate: 91,
  ...
  insurance: true,
  warranty: 'Government backed service',
  additionalServices: ['Training', 'Subsidies Support']
  },
  {
    id: 'drone-003',
  ...
  turnaroundTime: '24-48 hours',
  specializations: ['Precision Drone Lab', 'High-resolution Imaging'],
  successRate: 96,
  ...
  insurance: true,
  warranty: '6 months accuracy guarantee',
  additionalServices: ['On-site Demonstrations']
  }
];
