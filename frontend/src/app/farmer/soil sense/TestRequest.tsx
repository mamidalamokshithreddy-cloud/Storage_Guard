...
const TestRequest: React.FC<TestRequestProps> = ({ onBackToSoilSense }) => {
  ...
  const soilSenseServices = [
    {
      ...
      description: "Request comprehensive soil and water testing",
      descriptionTelugu: "సమగ్ర మట్టి మరియు నీటి పరీక్ష అభ్యర్థన",
      duration: "24 hours",
      price: "From ₹400",
      icon: TestTube,
      available: true
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white-50 to-white-50">
      <div className="container mx-auto px-4 py-6 max-w-full">
        <div className="space-y-6">
          <AgriChatAgent />
          <AgriAIPilotSidePeek
            agentType="SoilTest"
            agentName="Soil Test Agent"
            agentNameTelugu="మట్టి పరీక్ష ఏజెంట్"
