...
import { Upload, Snowflake, Package, ArrowLeft, ShoppingBag, Beaker, Scale, Thermometer, Clock, Zap, Droplets, Wheat, Factory, Microscope, Shield, BarChart3, Award } from "lucide-react";
...
const ProcessingHub: React.FC<ProcessingHubProps> = ({ 
  onBackToDashboard,
  ...
  // Sidebar services configuration extracted to avoid JSX parsing issues
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50">
      ...
      <div className="max-w-full mx-auto p-6 grid grid-cols-12 gap-6">
        {/* Main Content */}
